...
export default function ProductDistilleryForm({ currentValue }) {
  ...
  const onSubmit = async (data) => {
    await axiosInstance.put(`/productdistillery/${currentValue._id}`, data)
      .then((res) => {
  ...
  const onRemove = async () => {
    await axiosInstance.delete(`/productdistillery/${currentValue._id}`)
      .then((res) => {
  ...
  const onCreate = async (data) => {
    await axiosInstance.post('/productdistillery', data)
      .then((res) => {
