...
export default function ProductTypeForm({ currentValue }) {
  ...
  const onSubmit = async (data) => {
    await axiosInstance.put(`/producttype/${currentValue._id}`, data)
      .then((res) => {
  ...
  const onRemove = async () => {
    await axiosInstance.delete(`/producttype/${currentValue._id}`)
      .then((res) => {
  ...
  const onCreate = async (data) => {
    await axiosInstance.post('/producttype', data)
      .then((res) => {
