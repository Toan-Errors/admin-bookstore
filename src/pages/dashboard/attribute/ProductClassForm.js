...
export default function ProductClassForm({ currentValue }) {
  ...
  const onSubmit = async (data) => {
    await axiosInstance.put(`/productclass/${currentValue._id}`, data)
      .then((res) => {
  ...
  const onRemove = async () => {
    await axiosInstance.delete(`/productclass/${currentValue._id}`)
      .then((res) => {
  ...
  const onCreate = async (data) => {
    await axiosInstance.post('/productclass', data)
      .then((res) => {
