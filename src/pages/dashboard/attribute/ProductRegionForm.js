...
export default function ProductRegionForm({ currentValue }) {
  ...
  const onSubmit = async (data) => {
    await axiosInstance.put(`/productregion/${currentValue._id}`, data)
      .then((res) => {
  ...
  const onRemove = async () => {
    await axiosInstance.delete(`/productregion/${currentValue._id}`)
      .then((res) => {
  ...
  const onCreate = async (data) => {
    await axiosInstance.post('/productregion', data)
      .then((res) => {
