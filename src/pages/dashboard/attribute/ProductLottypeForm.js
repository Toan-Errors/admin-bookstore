...
export default function ProductLottypeForm({ productType, currentValue }) {
  ...
  const onSubmit = async (data) => {
    await axiosInstance.put(`/lottype/${currentValue._id}`, data)
      .then((res) => {
  ...
  const onRemove = async () => {
    await axiosInstance.delete(`/lottype/${currentValue._id}`)
      .then((res) => {
  ...
  const onCreate = async (data) => {
    await axiosInstance.post('/lottype', data)
      .then((res) => {
